...
> 2026-09-13 用户确认分期交付：以[两阶段验收合同](../../plans/2026-09-13-devmap-two-stage-acceptance.md)作为当前执行补充。第一阶段验证可替换性、真实简化效果与预注册的旧新版性能对照；本页绝对冷/热/刷新延迟目标保留在第二阶段。数据、兼容、资源、并发和恢复硬门槛不放宽。下文保留原设计时点内容供追溯。
